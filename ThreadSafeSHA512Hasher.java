...
public class ThreadSafeSHA512Hasher implements Hasher {
	...
	public String hash(final Path path) throws IOException {
		try {
			final MessageDigest threadLocalMessageDigest = MessageDigest.getInstance("SHA-512");
	...
	public void initialize() throws NoSuchAlgorithmException {
		messageDigestInstance = MessageDigest.getInstance("SHA-512");
	}
}